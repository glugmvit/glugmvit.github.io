...
![alt-text](https://image.slidesharecdn.com/objectorientedprogramming-151026072156-lva1-app6892/95/object-oriented-programming-4-638.jpg?cb=1446267724)
Similarly, we can imagine a class of Car as well!
...
However, there is a brief difference between these two ideas as follows (Credits: GeeksforGeeks)-
...
![alt-text](https://i.stack.imgur.com/bfBSY.png)
Let us try to see this in code:
```python
class Car:
